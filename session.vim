...
nnoremap <C-LeftMouse> <LeftMouse>msHmt'tzt`s*'tzt`s
...
argglobal
%argdel
$argadd boggle.find-words.sh
edit data/grids/sample-boggle-grid.01.txt
...
wincmd w
argglobal
if bufexists("data/grids/sample-boggle-grid.03.txt") | buffer data/grids/sample-boggle-grid.03.txt | else | edit data/grids/sample-boggle-grid.03.txt | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
